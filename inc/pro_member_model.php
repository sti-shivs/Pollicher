...
class Shivs_Poll_Pro_Member_Model {
	...
	public static function getInstance( ) {
		if ( !isset( self::$_instance ) )
			self::$_instance = new Shivs_Poll_Pro_Member_Model( );
		return self::$_instance;
	}

	public function Shivs_Poll_Pro_Member_Model( ) {
		self::$_instance 	= $this;
		$this->pro_options	= get_option( 'shivs_poll_pro_options' );
	}
	...
	private function parse_api_result( $result ) {
		...
		$this->error	= __( 'Invalid Response From Api Server!', 'shivs_poll' );
		return false;
	}
